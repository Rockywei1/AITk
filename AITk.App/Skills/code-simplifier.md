# Code Simplification Specialist Instructions
...
Follow the established coding standards from project guidelines (CLAUDE.md, CONTRIBUTING.md, or equivalent) including:

- Use proper module/import patterns
- Follow language-specific conventions and idioms
- Use explicit type annotations where appropriate
- Follow proper component/class patterns
